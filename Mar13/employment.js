function employment() {
    ...
    var svg = d3.select("#employment").append("svg").attr("width", total_width).attr("height", total_height)
    .append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    var x = d3.scaleLinear().domain([1995, 2020]).range([0, width]);
    ...
    d3.csv("data/employment.csv", function(emp_data) {
    d3.csv("data/frequency_truncated.csv", function(freq_data) {
